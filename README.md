...
This example shows how to read some descending neurons and co-visualise with 
the corresponding neurons in MANC.
...
![MANC to yakuba registration example](man/figures/README-manc-yakuba-registration.png)
